...
void UZonefallLocalizationSubsystem::BuildDictionary()
{
	...
	Add(TEXT("gfx.dlss"),        TEXT("NVIDIA DLSS"),      TEXT("NVIDIA DLSS"),      TEXT("NVIDIA DLSS"));
	Add(TEXT("gfx.framegen"),    TEXT("Frame Generation"), TEXT("Генерация кадров"), TEXT("帧生成"));
	Add(TEXT("gfx.fsr"),         TEXT("AMD FSR"),          TEXT("AMD FSR"),          TEXT("AMD FSR"));
